...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) { return <html lang="en"><body>{children}<LiveVotes /><StrainLibrary /><CommunityReviews /><BrandPartners /><ThemeToggle /></body></html> }